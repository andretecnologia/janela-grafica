...
public class Modal extends JFrame {
	...
	private void initComponents() {
		...
		cbTipo.setModel( new javax.swing.DefaultComboBoxModel( new String[] { "Titulo" } ) );
	...
	private void jMenuItem2ActionPerformed( java.awt.event.ActionEvent evt ) {
		FrmPrincipal fabout = new FrmPrincipal();
	...
	private void jButton1ActionPerformed( java.awt.event.ActionEvent evt ) {
		...
		if ( this.cbTipo.getSelectedIndex() == 0 ) {
			...
			this.taResultado.setText( vc.toString() );
		}
	}
